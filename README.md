...
|-------------|-----|-------------|-------|-------------------|
| 🔧 **DEV** | [Vote](https://vote-voting01-dev.agent.opsera.dev) / [Result](https://result-voting01-dev.agent.opsera.dev) | 3 days ago | srinivas-source | • `fbaea30-2026` (3 days ago) by _srinivas-source_<br>• `6f6e04b-2026` (3 days ago) by _srinivas-source_<br>• `53c108c-2026` (3 days ago) by _srinivas-source_<br>• `2bddff0-2026` (3 days ago) by _srinivas-source_<br>• `79a7cb1-2026` (3 days ago) by _srinivas-source_ |
| 🧪 **QA** | [Vote](https://vote-voting01-qa.agent.opsera.dev) / [Result](https://result-voting01-qa.agent.opsera.dev) | 3 days ago | srinivas-source | • `2bddff0-2026` (3 days ago) by _srinivas-source_<br>• `79a7cb1-2026` (3 days ago) by _srinivas-source_<br>• `3e53401-2026` (5 days ago) by _srinivas-source_<br>• `d46de3d-2026` (5 days ago) by _srinivas-source_<br>• `18593db-2026` (5 days ago) by _srinivas-source_ |
...
> 📅 _Last updated: 2026-02-14 12:08 UTC_ | [🔄 Refresh](https://github.com/opsera-agentic/enterprise-voting-demo-only/actions/workflows/deployment-landscape-voting01.yaml)
